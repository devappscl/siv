            ...
            <fieldset class="form-group">
                ...
                <label>Turno</label>
                <select name="turno" class="form-control" readonly='true'>
                    <option value="">Seleccione</option>
                    <option value="Mañana" <?php if(date("G" >= 15)){echo "selected='true'";}; ?>>MAÑANA</option>
                    <option value="Tarde" <?php if(date("G" < 15)){echo "selected='true'";}; ?>>TARDE</option>
                </select>
            </fieldset>
            ...
            <fieldset class="form-group">
                ...
                <option value="">Seleccione</option>
                  ...
                  <option value="3" >CIERRE CAJA VENTAS TURNO</option>
                  <option value="4" >CIERRE REDCOMPRA TURNO</option>
